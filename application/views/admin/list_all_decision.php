                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h1 class="title">Liste des décisions en cours</h1>
                                        </div>
																...
																<td>
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                      <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                          ...
                                                                          <a type="button" href="<?php echo base_url(); ?>index.php/admin/validstat/<?php echo $statuts->idStat; ?>" class="btn btn-primary">Oui</a>
                                                                        </div>
                                                                      </div>
                                                                    </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                      <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                          <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>
                                                                          <a type="button"  href="<?php echo base_url(); ?>index.php/admin/deletestat/<?php echo $statuts->idStat; ?>" class="btn btn-primary">Oui</a>
                                                                        </div>
                                                                      </div>
                                                                    </div>
                                                                    </div>
