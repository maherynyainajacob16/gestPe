                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h1 class="title">Les demandes de recupération Off</h1>
                                        </div>
                                        <section class="">
                                        <div class=""></div>
																...
																<td>
                                                                    ...
                                                                    <div class="modal fade" id="myModaledit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> 
                                                                      ...
                                                                      <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                          ...
                                                                          <a type="button" href="<?php echo base_url(); ?>index.php/model_recupOff/validJoff/<?php echo $recup->idjOff; ?>" class="btn btn-primary">Oui</a>
                                                                        </div>
                                                                      </div>
                                                                    </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                      <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                          <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>
                                                                          <a type="button"  href="<?php echo base_url(); ?>index.php/model_recupOff/annulJoff/<?php echo $recup->idjOff; ?>" class="btn btn-primary">Oui</a>
                                                                        </div>
                                                                      </div>
                                                                    </div>
                                                                    </div>
