...
<body style="background-color: dodgerblue;">
	...
	<div class="container">
	<h1 class="text-center">Modifier ma demande </h1>
	...
	<div class="col-md-8">
		<div class="well">
			<form  action="" method="POST" class="">
				...
				<input type="text" name="uMatricule" class="form-control" value = "<?php echo $_SESSION['uMatricule'] ; ?>" disabled>	
				</div>
				<div class="form-group">
				<label for="numDemande" class="">N° Demande:</label>
				<input type="text" name="numDemande" class="form-control" value = "<?php echo $demande->numDemande ; ?>">
				</div>
				<div class="form-group">
				<label for="motif" class="">Motif de la demande:</label>
				<select class="form-control" id="motif" name="motif" value="<?php echo $demande->motif; ?>">
				...
				<input type="date" name="date_debut_demande" id="date_debut_demande" class="form-control" value="<?php echo $demande->date_debut_demande; ?>">	
				</div>
				<div class="form-group">
				<label for="date_fin_demande" class="">Date fin</label>
				<input type="date" name="date_fin_demande" id="date_fin_demande" class="form-control" value="<?php echo $demande->date_fin_demande; ?>">	
				</div>
				<div class="">
					<button class="btn btn-success" name="update_demande">Save</button>
				</div>
			</form>
		</div>
	</div>
